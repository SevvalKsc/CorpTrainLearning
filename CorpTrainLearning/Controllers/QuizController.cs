...
namespace CorpTrainLearning.Controllers
{
    public class QuizController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Quiz.Include(q => q.Course);
        ...
        public async Task<IActionResult> Create([Bind("QuizId,CourseId")] Quiz quiz)
        {
            ...
            ViewData["CourseId"] = new SelectList(_context.Course, "CourseId", "Title", quiz.CourseId);
            return View(quiz);
        }
